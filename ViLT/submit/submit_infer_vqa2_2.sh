...
LOG_DIR=/blob/v-jinx/checkpoint_vilt/finetune_full_last/pretrain_vqa_ft_full/version_1/checkpoints
...
load_path="/blob/v-jinx/checkpoint_vilt/finetune_full_last/pretrain_vqa_ft_full/version_1/checkpoints/last.ckpt"
