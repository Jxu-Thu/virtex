...
mox.copy_parallel("s3://bucket-7001/luoxu/dataset/coco/train_new", "/cache/train2014")
mox.copy_parallel("s3://bucket-7001/luoxu/dataset/coco/val2014", "/cache/val2014")
mox.copy_parallel("s3://bucket-7001/luoxu/dataset/coco/dataset_coco.json", "/cache/dataset_coco.json")
...
if __name__ == '__main__':
    make_arrow('/cache', '/cache')
    mox.copy_parallel("/cache/coco_caption_karpathy_train.arrow", "s3://bucket-7001/luoxu/dataset/MMT/coco_caption_karpathy_train.arrow")