...
pre_trained_model="/blob/v-jinx/checkpoint_vilt/finetune_val_best/pretrain_indomain24GPU_pretrain_conv_bottom_conmask_nlvr_ft/version_2/checkpoints/last.ckpt"
