...
EXP_NAME=pretrain_indomain24GPU_h512_without_pretrain_conv_bottom_coco_irtr_ft
DATA_ROOT=/blob/v-jinx/data/VilT_dataset
LOG_DIR=/blob/v-jinx/checkpoint_vilt/finetune_val_best
RESUME_DIR=/blob/v-jinx/checkpoint_vilt/pre_train/pretrain_indomain24GPU_h512_without_pretrain_conv_bottom/version_3/checkpoints/last.ckpt
