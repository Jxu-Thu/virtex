...
TASK=vqa2
run_model=task_finetune_vqa_randaug
pre_trained_model="/blob/v-jinx/checkpoint_vilt/finetune_val_best/pretrain_indomain24GPU_pretrain_conv_bottom_conmask_vqa_ft/version_3/checkpoints/last.ckpt"
