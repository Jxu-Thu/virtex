...
class linear_eval_callback(BaseFinetuning):
    ...
    def freeze_before_training(self, pl_module: 'pl.LightningModule'):
        self.freeze(pl_module.backbone, self.train_bn)
    
    def finetune_function(self, pl_module: 'pl.LightningModule', epoch: int, optimizer: Optimizer, opt_idx: int):
        """ No finetuning happens"""
        pass

# print(isinstance(linear_eval_callback, typing.Union[typing.List[pl.callbacks.base.Callback], pl.callbacks.base.Callback]))

# class BaseFinetuning(pl.Callback):
#     r"""
